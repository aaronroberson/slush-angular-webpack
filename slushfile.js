...
gulp.task('default', function (done) {
  inquirer.prompt([
    {type: 'input', name: 'name', message: 'What should your project be named?', default: 'one'}
  ],
  function (answers) {
    ...
    files.push(__dirname + '/templates/pack/*.js');
    files.push(__dirname + '/templates/pack/*.css');
